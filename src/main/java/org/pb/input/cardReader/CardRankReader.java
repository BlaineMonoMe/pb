...
public class CardRankReader {
	...
	private HashMap<TwoColors, Character> colorRankMap;

	public CardRankReader() {
		colorRankMap = new HashMap<TwoColors, Character>();
		initialize();
	}
	...
	private void initialize() {
		try {
			...
			while (line != null) {
				...
				colorRankMap.put(twoColors, charLevel);
	...
	public char getLevel(BufferedImage img) {
		...
		return colorRankMap.get(twoColors);
	}
}
